//package com.dongyang.android.boda.VoiceChat.Model;
//
...
//    public MyEngineEventHandler(Context ctx, io.agora.openacall.model.EngineConfig config) {
//        this.mContext = ctx;
//        this.mConfig = config;
//    }
//
//    private final io.agora.openacall.model.EngineConfig mConfig;
//
//    private final Context mContext;
//
//    private final ConcurrentHashMap<io.agora.openacall.model.AGEventHandler, Integer> mEventHandlerList = new ConcurrentHashMap<>();
//
//    public void addEventHandler(io.agora.openacall.model.AGEventHandler handler) {
//        this.mEventHandlerList.put(handler, 0);
//    }
//
//    public void removeEventHandler(io.agora.openacall.model.AGEventHandler handler) {
...
//            Iterator<io.agora.openacall.model.AGEventHandler> it = mEventHandlerList.keySet().iterator();
//            while (it.hasNext()) {
//                io.agora.openacall.model.AGEventHandler handler = it.next();
...
//            while (it.hasNext()) {
//                io.agora.openacall.model.AGEventHandler handler = it.next();
//                handler.onExtraCallback(io.agora.openacall.model.AGEventHandler.EVENT_TYPE_ON_SPEAKER_STATS, (Object) speakerInfos);
//            }
//        }
//
//        /**
...
//            while (it.hasNext()) {
//                io.agora.openacall.model.AGEventHandler handler = it.next();
//                handler.onExtraCallback(io.agora.openacall.model.AGEventHandler.EVENT_TYPE_ON_AGORA_MEDIA_ERROR, error, RtcEngine.getErrorDescription(error));
//            }
//        }
//
//        /**
...
//            while (it.hasNext()) {
//                io.agora.openacall.model.AGEventHandler handler = it.next();
//                handler.onExtraCallback(io.agora.openacall.model.AGEventHandler.EVENT_TYPE_ON_AUDIO_QUALITY, uid, quality, delay, lost);
//            }
//        }
//
//        /**
...
//            while (it.hasNext()) {
//                io.agora.openacall.model.AGEventHandler handler = it.next();
//                handler.onExtraCallback(io.agora.openacall.model.AGEventHandler.EVENT_TYPE_ON_APP_ERROR, io.agora.openacall.model.ConstantApp.AppError.NO_NETWORK_CONNECTION);
//            }
//        }
//
//        /**
...
//            while (it.hasNext()) {
//                io.agora.openacall.model.AGEventHandler handler = it.next();
//                handler.onExtraCallback(io.agora.openacall.model.AGEventHandler.EVENT_TYPE_ON_AUDIO_ROUTE_CHANGED, routing);
//            }
//
//        }
//    };
