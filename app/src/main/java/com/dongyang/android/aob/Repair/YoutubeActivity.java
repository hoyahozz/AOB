...
public class YoutubeActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.youtube_menu_tire:
                loadingDialog.show();
                y_datas.clear();
                searchTask("자전거 타이어 고치는 방법");
                return true;

            case R.id.youtube_menu_saddle:
                loadingDialog.show();
                y_datas.clear();
                searchTask("자전거 안장 교체");
                return true;

            case R.id.youtube_menu_handle:
                loadingDialog.show();
                y_datas.clear();
                searchTask("자전거 핸들 고치는 방법");
                return true;

            case R.id.youtube_menu_chain:
                loadingDialog.show();
                y_datas.clear();
                searchTask("자전거 체인 수리");
                return true;
